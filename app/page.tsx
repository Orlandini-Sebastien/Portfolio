	...
	return (
		<main className=" flex min-h-screen flex-col items-center bg-slate-50 shadow-xl">
			...
			<div className="w-11/12 flex xl:hidden max-xl:flex-col my-4">
				<div className="text-gray-900 md:text-lg lg:text-xl  xl:text-2xl font-bold h-2/3 px-4 flex justify-start items-center w-full   ">
					<Image
				...
				<div className="flex max-md:flex-col  w-full justify-end items-center">
					...
					<iframe
						...
						width="300"
						height="300"
						className="border-2 rounded-full border-orange-500 shadow-xl "
						loading="lazy"
					></iframe>
				</div>
			</div>
